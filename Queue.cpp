...
static int      QueRegister(char const * pszRootPath, SharedBlock * pSHB);
static int      QueUnregister(SharedBlock * pSHB);
static SharedBlock *QueGetShared(char const * pszBasePath);
...
///////////////////////////////////////////////////////////////////////////////
    if (ShbCreateBlock(SHB_Queue,
            sizeof(QueueArena) + iNumDirsLevel * iNumDirsLevel * sizeof(QueueDir)) < 0)
        return (ErrGetErrorCode());


    SHB_HANDLE      hShbQueue = ShbConnectBlock(SHB_Queue);

    if (hShbQueue == SHB_INVALID_HANDLE)
    {
        ErrorPush();
        ShbDestroyBlock(SHB_Queue);
        return (ErrorPop());
    }
...
///////////////////////////////////////////////////////////////////////////////
    if (QueRegister(pszRootPath, &SHB_Queue) < 0)
    {
        ErrorPush();
        ShbDestroyBlock(SHB_Queue);
        return (ErrorPop());
...
///////////////////////////////////////////////////////////////////////////////
    SharedBlock    *pSHB = QueGetShared(pszRootPath);
...
//  Get associated shared block
///////////////////////////////////////////////////////////////////////////////
    SharedBlock    *pSHB = QueGetShared(pszBasePath);
