...
#
# Swap comments on these two lines to build the Maildir version of XMail.
# Remember that Maildir is not compatible with the old mailbox structure, so You've
# to convert Your accounts ( if any ) to the new Maildir format.
#
CFLAGS = -O2 -I. -D__LINUX__ -DXMAIL_PPC -D_REENTRANT=1 -D_THREAD_SAFE=1
# CFLAGS = -O2 -I. -D__LINUX__ -DXMAIL_PPC -DCONFIG_MAILDIR -D_REENTRANT=1 -D_THREAD_SAFE=1
