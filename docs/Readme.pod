...
during message delivery. The difference between "redirect" and "lredirect" is the
following. Suppose A@B sends a message to C@D, that has a redirect to E@F. With
"redirect" E@F will see A@B has sender while with "lredirect" he will see C@D.
